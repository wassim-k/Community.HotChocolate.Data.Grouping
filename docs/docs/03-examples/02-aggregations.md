...
4 (employee, Alpha-project) rows: Alice's Alpha (10k) + Bob's Alpha (15k) + Dave's Alpha (12k) + Grace's Alpha (8k). Budgets sum to 45k, average to 11250, range 8k-15k. SQL `JOIN` semantics. See [Collection-navigation keys](./grouping#collection-navigation-keys).
