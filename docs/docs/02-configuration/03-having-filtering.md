...
OR composition **across different aggregate operations** is a separate limitation. See [OR across different aggregates](../architecture/limitations#or-across-different-aggregates).
