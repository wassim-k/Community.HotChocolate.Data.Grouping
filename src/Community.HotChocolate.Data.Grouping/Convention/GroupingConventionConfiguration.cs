...
public class GroupingConventionConfiguration
{
    ...
    /// <summary>
    /// CLR-runtime-type to <see cref="GroupingScalarKind"/> registry; controls which types are
    ...
    /// <summary>
    /// CLR-runtime-type to <c>*AggregateResultType</c>. Drives the output-schema choice (which
