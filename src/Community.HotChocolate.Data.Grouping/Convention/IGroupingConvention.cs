...
/// filter-side concerns (operations, runtime-to-filter input bindings, configure-overlays, expression
...
public interface IGroupingConvention : IConvention
{
    ...
    /// <summary>Aggregate operations exposed on every <c>*AggregateResult</c>.</summary>
    GroupingAggregations AllowedAggregations { get; }
