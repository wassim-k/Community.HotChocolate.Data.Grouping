...
{
    private readonly Dictionary<AggregationKind, AggregateResultOperationDescriptor> _operations = [];
    ...
    /// <inheritdoc />
    public IAggregateResultOperationDescriptor Operation(AggregationKind kind)
    {
