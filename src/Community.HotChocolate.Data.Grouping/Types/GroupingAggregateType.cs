...
internal sealed class GroupingAggregateType<T> : ObjectType
{
    ...
    protected override ObjectTypeConfiguration CreateConfiguration(ITypeDiscoveryContext context)
    {
        ...
        foreach (var member in context.TypeInspector.GetMembers(typeof(T)))
        {
            ...
            else
            {
                ...
                schemaTypeClr = typeof(GroupingAggregateType<>).MakeGenericType(nullableElementSource);
            }
        ...
        ObjectTypeConfiguration configuration)
    {
        ...
        SetTypeIdentity(typeof(GroupingAggregateType<>));
